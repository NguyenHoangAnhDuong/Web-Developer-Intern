...
<head>
    ...
    <title>Xác thực OTP - Đặt lại mật khẩu</title>
...
<c:if test="${not empty sessionScope.toastMessage}">
    <div class="toast ${sessionScope.toastType}" id="toast"><c:out value="${sessionScope.toastMessage}"/></div>
...
<div class="otp-card">
    ...
    <p class="subtitle">
        ...
        <strong><c:out value="${maskedEmail}"/></strong><br>
    ...
    <form method="post" action="${pageContext.request.contextPath}/verify-reset-otp">
        <input type="text"
               name="otp"
               class="otp-input"
               maxlength="6"
    ...
    <div class="resend-area">
        Không nhận được mã?
        <form method="post" action="${pageContext.request.contextPath}/verify-reset-otp" style="display:inline">
            <input type="hidden" name="action" value="resend">
            <button type="submit" id="resend-btn" disabled>Gửi lại (<span id="resend-timer">60</span>s)</button>
        </form>
    </div>

    <a class="back-link" href="${pageContext.request.contextPath}/forgot-password">← Nhập lại email</a>
</div>
