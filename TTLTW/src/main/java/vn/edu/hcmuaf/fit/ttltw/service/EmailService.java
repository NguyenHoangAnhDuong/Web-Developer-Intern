...
public class EmailService {
    ...
    public static void sendOtp(String toEmail, String otp) throws MessagingException, UnsupportedEncodingException {
        send(toEmail,
             ...
             buildOtpTemplate(otp,
                     "Bạn vừa yêu cầu đăng ký tài khoản tại <strong>TTLTW Store</strong>.<br>" +
                     "Vui lòng nhập mã OTP bên dưới để hoàn tất:"));
    }
    ...
    public static void sendResetOtp(String toEmail, String otp) throws MessagingException, UnsupportedEncodingException {
        send(toEmail,
             ...
             buildOtpTemplate(otp,
                     "Bạn vừa yêu cầu đặt lại mật khẩu cho tài khoản <strong>TTLTW Store</strong>.<br>" +
